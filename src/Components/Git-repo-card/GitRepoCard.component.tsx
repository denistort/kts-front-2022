...
const GitRepoCard = ({ title, orgLink, orgName, rating, date}: IGitRepoProps) => {
	...
	return(
			...
			<div className={styles['git-repo-tile__body-wraper']}>
				...
				<p>
					<a className={styles['git-repo-tile__org-link']} href={orgLink}>{orgName}</a>
				</p>
				<div className={styles['git-repo-tile__footer-repos']}>
					<div className={styles['footer-repos__rating']}>
						<svg className={styles['rating__star-logo']} width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
